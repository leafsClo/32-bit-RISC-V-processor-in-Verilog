...
#
# Generated by Vivado on Tue Mar 31 02:53:21 IST 2026
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/p1.srcs/sources_1/imports/Processor/ALU.v"]"\
 "[file normalize "$origin_dir/p1.srcs/sources_1/imports/Processor/REG_FILE.v"]"\
 "[file normalize "$origin_dir/p1.srcs/sources_1/imports/Processor/DATAPATH.v"]"\
 "[file normalize "$origin_dir/p1.srcs/sources_1/imports/Processor/INST_MEM.v"]"\
 "[file normalize "$origin_dir/p1.srcs/sources_1/imports/Processor/IFU.v"]"\
 "[file normalize "$origin_dir/p1.srcs/sources_1/imports/Processor/CONTROL.v"]"\
 "[file normalize "$origin_dir/p1.srcs/sources_1/imports/Processor/PROCESSOR.v"]"\
 "[file normalize "$origin_dir/p1.srcs/constrs_1/new/PROCESSOR.xdc"]"\
 "[file normalize "$origin_dir/p1.srcs/sources_1/imports/Processor/ALU.v"]"\
 "[file normalize "$origin_dir/p1.srcs/sources_1/imports/Processor/CONTROL.v"]"\
 "[file normalize "$origin_dir/p1.srcs/sources_1/imports/Processor/IFU.v"]"\
 "[file normalize "$origin_dir/p1.srcs/sources_1/imports/Processor/INST_MEM.v"]"\
 "[file normalize "$origin_dir/p1.srcs/sources_1/imports/Processor/REG_FILE.v"]"\
 "[file normalize "$origin_dir/p1.srcs/sources_1/imports/Processor/DATAPATH.v"]"\
 "[file normalize "$origin_dir/stimulus_behav1.wcfg"]"\
 "[file normalize "$origin_dir/p1.srcs/sim_1/imports/Processor/Processor_tb.v"]"\
 "[file normalize "$origin_dir/p1.srcs/utils_1/imports/synth_1/PROCESSOR.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../../RISC-V-Processor/Processor/CONTROL.v"]"\
 "[file normalize "$origin_dir/../../RISC-V-Processor/Processor/ALU.v"]"\
 "[file normalize "$origin_dir/../../RISC-V-Processor/Processor/REG_FILE.v"]"\
 "[file normalize "$origin_dir/../../RISC-V-Processor/Processor/INST_MEM.v"]"\
 "[file normalize "$origin_dir/../../RISC-V-Processor/Processor/PROCESSOR.v"]"\
 "[file normalize "$origin_dir/../../RISC-V-Processor/Processor/DATAPATH.v"]"\
 "[file normalize "$origin_dir/../../RISC-V-Processor/Processor/IFU.v"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set file "[file normalize "$origin_dir/p1.srcs/constrs_1/new/PROCESSOR.xdc"]"
...
set file "$origin_dir/../../RISC-V-Processor/Processor/CONTROL.v"
...
set file "$origin_dir/../../RISC-V-Processor/Processor/ALU.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog Header" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../RISC-V-Processor/Processor/REG_FILE.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog Header" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../RISC-V-Processor/Processor/INST_MEM.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog Header" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../RISC-V-Processor/Processor/PROCESSOR.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog Header" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../RISC-V-Processor/Processor/DATAPATH.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog Header" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../RISC-V-Processor/Processor/IFU.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog Header" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
